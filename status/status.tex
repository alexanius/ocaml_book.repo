...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
	...
	\hline
	\hline
	\multirow{21}*{II} & \multicolumn{8}{|c|}{Часть II} \\
	\cline{2-9}
	\cline{2-9}
	 & \multirow{11}*{2} & \multicolumn{2}{|c|}{Функциональное программирование} & \no & \no & \no & \no & \no \\
	\cline{3-9}
	 & & 1 & Введение & \yes & \yes & \no & \no & \no \\
	\cline{3-9}
	...
	\cline{2-9}
	\cline{2-9}
	 & \multirow{11}*{3} & \multicolumn{2}{|c|}{Императивное программирование} & \no & \no & \no & \no & \no \\
	\cline{3-9}
	 & & 1 & Введение & \yes & \yes & \no & \no & \no \\
	\cline{3-9}
	 &  & 2 & План главы & \yes & \yes & \no & \no & \no \\
	...
	\cline{2-9}
	\cline{2-9}
	 & \multirow{9}*{11} & \multicolumn{2}{|c|}{Средства лексического и синтаксического анализа} & \yes & \no & \no & \no & \no \\
	\cline{3-9}
